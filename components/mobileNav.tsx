...
const MobileNav = ({nav, closeNav}: Props) => {
    ...
    return(
        <div className = "{fixed ${navAnimation} transform transition-all duration-300 top-0 right-0 bottom-0 z-[10000] bg-[#09101a]}">
            <div className = "w-[180vw] h-[100vh] flex flex-col items-center justify-center">
                <div className = "nav-link-mobile">Home</div>
                <div className = "nav-link-mobile">About me</div>
                <div className = "nav-link-mobile">Projects</div>
                <div className = "nav-link-mobile">Contact</div>
            </div>
            <div onClick = {closeNav} className= "absolute cursor-pointer top-[2rem] right-[2rem] h-[2rem] text-violet-300">
                <XMarkIcon/>
            </div>
        </div>
    );
